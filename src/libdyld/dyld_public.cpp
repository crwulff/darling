...
{
#ifdef DEBUG
	MachOMgr::instance()->objectByIndex(image_index)->elf.addSymbol(name, addr);
#endif
}
...
{
#ifdef DEBUG
	GDBInterface::addELF(&MachOMgr::instance()->objectByIndex(image_index)->elf);
#endif
}
...
void _dyld_register_func_for_add_objc_class(MachOMgr::ClassRegisterHookFunc* func)
{
	MachOMgr::instance()->registerClassHook(func);
}
