...
CF_EXPORT
const CFStringRef kCFManagedPreferencesMCXObjectName;
CF_EXPORT
const CFStringRef kCFManagedPreferencesMCXNotificationName;
CF_EXPORT
const CFStringRef kCFPreferencesDidChangeNotificationName;
CF_EXPORT
const CFStringRef kCFPreferencesWebServicesProviderTypeMap;
CF_EXPORT
const CFStringRef kCFPreferencesWebServicesProviderTypeWebSearch;
CF_EXPORT
const CFStringRef kCFPreferencesDidChangeObject;
